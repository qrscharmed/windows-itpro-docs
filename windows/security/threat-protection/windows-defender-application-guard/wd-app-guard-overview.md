...
Application Guard has been created to target enterprise and personal systems:
...
- **Personal devices.** These personally-owned desktops or mobile laptops are not domain-joined or managed by an organization. The user is typically an admin on the device and uses a high-bandwidth wireless personal network while at home.
